...
const entries = {
     '@youwol/installers-vs-flow': './lib/index.ts',
    ...Object.values(secondaryEntries).reduce( (acc,e) => ({...acc, [`@youwol/installers-vs-flow/${e.name}`]:e.entryFile}), {})
}
export const setup = {
    ...
    sourceGithub:'https://github.com/youwol/installers-vs-flow',
    userGuide:'https://l.youwol.com/doc/@youwol/installers-vs-flow',
    apiVersion:'01',
    runTimeDependencies,
    externals,
    exportedSymbols,
    ...
    installMainModule: ({cdnClient, installParameters}:{
        ...
        return cdnClient.install({
            ...
            return window[`@youwol/installers-vs-flow_APIv01`]
        })
    },
    installAuxiliaryModule: ({name, cdnClient, installParameters}:{
        ...
        const scripts = [
            ...(parameters.scripts || []),
            `@youwol/installers-vs-flow#0.1.0-wip~dist/@youwol/installers-vs-flow/${entry.name}.js`
        ]
        const modules = [
            ...(parameters.modules || []),
        ...
        return cdnClient.install({
            ...
            return window[`@youwol/installers-vs-flow/${entry.name}_APIv01`]
        })
    },
